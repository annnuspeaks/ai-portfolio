export default function Hero() {
  return (
    <section
      id="home"
      className="relative flex min-h-screen items-center justify-center px-6 pt-32 md:pt-24"
    >
  ...
  For Real World Impact
        ...
        <p className="mx-auto max-w-3xl px-4 md:px-0 text-lg text-slate-400 md:text-xl">
          AI Engineer, Machine Learning Practitioner, and Data Science
          Enthusiast building production-ready intelligent systems, MLOps
          pipelines, forecasting platforms, recommendation engines, and
